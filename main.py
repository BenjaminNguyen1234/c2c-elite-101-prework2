...
weather_responses = ["Hows the weather?", "It's pretty nice outside", "Tell me how it is out there"]
...
def weatherfunc():
  ...
  if random.choice(weather_responses) == weather_responses[0]:
    ...
    print("Is it really? I couldn't tell, I'm just a program inside your browser.")
...
while endless == True:
  ...
  if choice == posstopics[0]:
    ...
    if userbirthday == "":
      ...
      birthday(userage)
    elif input("You already have a birthday saved, would you like to edit it?").capitalize() == "Yes":
      birthday()
    else:
      print(userbirthday)
    ...
    miscfunc()
    print(f"Your current favorite things are : {favgame}, {favcolor}, {favsports}, {favshow}")
